    ...
    <section id="contact" className="py-24 md:py-36 bg-transparent overflow-hidden relative border-t border-white/5">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="max-w-3xl mb-20">
          <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-[#ea222d] block mb-3">COLLABORATE</span>
          ...
          >
            ...
            <div className="bg-zinc-900/30 p-8 border border-white/5 rounded-2xl flex flex-col gap-6 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),_0_15px_35px_rgba(0,0,0,0.6)]">
              <div className="flex gap-4">
                ...
                <div>
                  <span className="text-[9px] font-black tracking-widest text-gray-500 uppercase block mb-1.5">Corporate Address</span>
                  <a 
                  ...
                  <p className="text-gray-400 text-xs md:text-sm font-light leading-relaxed">
                    ...
                    S.G. Highway, Ahmedabad – 380060,<br />
                    Gujarat, India
                  </p>
                </div>
              </div>
            ...
            <div className="bg-zinc-900/30 p-8 border border-white/5 rounded-2xl flex gap-4 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),_0_15px_35px_rgba(0,0,0,0.6)]">
              ...
              <div>
                <span className="text-[9px] font-black tracking-widest text-gray-500 uppercase block mb-1.5">Registered Address</span>
